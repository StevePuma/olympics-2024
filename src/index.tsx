...
const sisenseToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiNjY3MTk0MTZmNzA0ZmEwMDJlZTYyNWFkIiwiYXBpU2VjcmV0IjoiYjZjZjhkZWUtMDBkNC0zNDFmLTFkZjQtYzBjYzZjMzljYzY3IiwiYWxsb3dlZFRlbmFudHMiOlsiNjUwMGIzYTBiZjQ1MTgwMDFiNDc5NjAzIl0sInRlbmFudElkIjoiNjUwMGIzYTBiZjQ1MTgwMDFiNDc5NjAzIn0.8U7817CqWy-uzS0-WmiobCHrieC21y5JzLC7-kZIFQM";

if (!sisenseUrl || !sisenseToken) {
  throw new Error(
    "Environment variables REACT_APP_SISENSE_URL and REACT_APP_SISENSE_TOKEN must be defined",
  );
}
